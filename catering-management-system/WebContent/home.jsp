...
<body>
    ...
    <header class="jumbotron my-4">
      ...
      <a href="cust_product_list.htm" class="btn btn-success btn-lg">Order Now!</a>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="https://lh3.googleusercontent.com/proxy/PRjQXZDNFMQV-1i_4b88sbYytsOjZvpPTl8MfTK_YCDKpLF27A9fraAiGK4JYLo6XypRwJKoucy-8TWqgMAljbUYKbx4Wr0FmZWtydFrP6oRGlEZAVkA_4sK4RZ7VjA8Osj_5B8wf1pIsR1TQFI-faaZP6M8mKHwmIqswT6ktxJl-Uy8-TpqKWK9Lwf0DR_D6Iz3cOdRiw" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; FoodWiseIndia.com 2020</p>
    </div>
    <!-- /.container -->
  </footer>
