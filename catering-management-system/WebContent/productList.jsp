  ...
  <% 
    ...
    <tr>
      ...
      <td><%=prod.getProductName()%> </td>
       ...
       <td>Rs. <%=prod.getProductPrice()%></td>
       
       <td><a href="product_update_form.htm?productId=<%=prod.getProductId()%>">Update</a></td>
       <td> <a href="product_delete.htm?productId=<%=prod.getProductId()%>">Delete</a></td>
    </tr>
